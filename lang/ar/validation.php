...
return [
    ...
    'invalid_link' => 'رابط أو رمز التحقق غير صالح.',
    'already_verified' => 'تم التحقق من البريد الإلكتروني مسبقاً.',
    'event_id.exists' => 'حدث خطا ما، يرجى المحاولة مرة أخرى لاحقاً.',
    'booth_id.exists' => 'حدث خطا ما، يرجى المحاولة مرة أخرى لاحقاً.',
    'invalid_status' => 'حدث خطا ما، يرجى المحاولة مرة أخرى لاحقاً.',
    'hall_unavailable' => 'القاعة غير متاحة',
];
