...
Route::prefix('exhibitor')->middleware('auth:system')->group(function(){
    ...
    Route::get('profile', [ProfileController::class, 'show'])->name('exhibitor.profile.show');
    Route::post('profile', [ProfileController::class, 'update'])->name('exhibitor.profile.update')->middleware('throttle:profile_update');
});
